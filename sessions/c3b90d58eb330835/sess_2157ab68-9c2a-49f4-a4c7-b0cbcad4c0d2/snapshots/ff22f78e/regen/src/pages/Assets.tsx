          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <p className={`mt-1 text-sm font-bold ${
                asset.condition === 'GOOD' ? 'text-healthy'
        ...
        <div className="card-body">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <>
                  ...
                  <div className="mt-1">
                    <span className={`text-xs px-2 py-0.5 rounded font-medium ${
                      tc.status === 'NORMAL' ? 'bg-green-100 text-green-700'
            ...
            <div className={`p-3 rounded border bg-white ${
              asset.condition === 'CRITICAL' ? 'border-red-200 bg-red-50'
          ...
          {['ALL', 'GOOD', 'FAIR', 'WARNING', 'CRITICAL'].map(c => (
            <button
              ...
              className={`text-xs px-3 py-1.5 rounded-full border font-medium transition-colors ${
                filter === c ? 'bg-[#145DA0] text-white border-[#145DA0]'
